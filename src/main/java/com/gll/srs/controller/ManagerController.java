...
import com.gll.srs.model.TableInfo;
...
public class ManagerController {
    ...
    private List<com.gll.srs.model.User> users = new ArrayList<>();
    private List<com.gll.srs.model.Message> messageList = new ArrayList<>();
    ...
    public JsonResult editUser(@RequestParam String register_data, @RequestParam String userID, HttpServletRequest request, HttpServletResponse response) {
        ...
        com.gll.srs.model.User user = JSON.parseObject(register_data, com.gll.srs.model.User.class);

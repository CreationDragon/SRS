...
public class ManagerRepository {
    ...
    public com.gtt.srs.model.User getUserInfoById(Integer userid) {
        com.gtt.srs.model.User user = new com.gtt.srs.model.User();
        try {
            user = jdbcTemplate.queryForObject("SELECT * FROM USER WHERE user_id= ? ", new Object[]{userid}, new BeanPropertyRowMapper<>(com.gtt.srs.model.User.class));
        } catch (Exception e) {
            return user;
        }
        return user;
    ...
    public String editUser(com.gtt.srs.model.User user, Integer userid) {
        String msg = null;
